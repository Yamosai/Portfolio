...
<body data-spy="scroll" data-target="#myNavbar">
    ...
    <section id="about" classe="container-fluide">
        ...
        <div class="imgPerso">
            <a href="https://github.com/Yamosai" target="_blank" class="btnGHithub"><img class="imgGithub" src="image/github.png"> </a>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="heading">
                        <h2 id="RealisationTitle"> Réalisations </h2>
                    </div>
                </div>
            </div>
    ...
    <section id="skills">
        <div class="container">
            <div class="row">
                <h2 id="competenceTitle"> Compétences </h2>
                <div class="col-md-6">
                    <div class="progress">
    ...
    <section id="education">
        <div class="container">
            ...
            <div class="heading">
                <h2 id="educationTitle"> Éducation </h2>
                <div class="row">
                    <div class="col-sm-6">
